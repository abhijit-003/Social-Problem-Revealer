...
<html lang="en">
  <head>
    ...
    <title>SPR | User Register Complaint</title>
...
<label class="col-sm-2 col-sm-2 control-label">Problem Category </label>
 <div class="col-sm-4">
<select name="subcategory" id="subcategory" class="form-control" >
<option value="">Select Subcategory</option>
<option value="">Road Problem</option>
<option value="">Light Problem</option>
<option value="">Water Problem</option>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Related Pictures(if any) </label>
<div class="col-sm-6">
<input type="file" name="compfile" class="form-control" value="" accept="image/*" />
</div>
</div>
